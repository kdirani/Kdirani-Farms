  ...
  const cards = [
    {
      ...
      value: stats.total_eggs_produced.toLocaleString('en-US'),
      icon: Egg,
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
    },
    {
      ...
      value: stats.total_eggs_sold.toLocaleString('en-US'),
      icon: TrendingUp,
    ...
    },
    {
      ...
      value: `${stats.total_feed_consumed.toLocaleString('en-US')} كغم`,
      icon: Wheat,
    ...
    },
    {
      ...
      value: `${stats.total_droppings_sold.toLocaleString('en-US')} كغم`,
      icon: Trash2,
    ...
    },
    {
      ...
      value: stats.total_mortality.toLocaleString('en-US'),
      icon: Bird,
      color: 'text-red-600',
      bgColor: 'bg-red-50',
    },
    {
      ...
      value: stats.average_daily_production.toLocaleString('en-US'),
      icon: BarChart3,
